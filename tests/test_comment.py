...
class TestPostAPI:
    ...
    @pytest.mark.django_db(transaction=True)
    def test_comments_get_unauth(
        self, client, post, comment_1_post, comment_2_post, comment_1_another_post
    ):
    ...
    @pytest.mark.django_db(transaction=True)
    def test_post_unauth_patch_current(
        self, client, post, comment_1_post, comment_2_post
    ):
    ...
    @pytest.mark.django_db(transaction=True)
    def test_post_unauth_delete_current(
        self, client, post, comment_1_post, comment_2_post
    ):
